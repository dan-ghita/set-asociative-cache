...
namespace SetAssociativeCache.EvictionPolicy
{
    ...
    public class LRUEvictionPolicy<TValue> : IEvictionPolicy<TValue>
    {
        /// <summary>
        ...
        {
            long minAccessTime = container.Min(x => x.AccessTime);

            return container.FindIndex(element => element.AccessTime == minAccessTime);
        }
    }
}
